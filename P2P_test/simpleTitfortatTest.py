...
if __name__ == '__main__':
    ...
    # I = PClient(tracker_address, upload_rate=10000, download_rate=100000, port=40009, tit_tat=False)
    # J = PClient(tracker_address, upload_rate=10000, download_rate=100000, port=40010, tit_tat=False)
